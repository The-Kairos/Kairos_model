...
| BLIP + YOLO + AST + ASR in Gemini2.5Pro |          5.93 |        0.056 |           0 |      0.019 |           0 |

**Footnote:**
`total_process_sec` without LLM cooldown of 667.76s is **2.61× longer** than `video_length` of 255.77s.
...
| BLIP + YOLO + AST + ASR in Gemini2.5Pro |         4.784 |        0.067 |           0 |      0.037 |           0 |

**Footnote:**
`total_process_sec` without LLM cooldown of 460.97s is **1.69× longer** than `video_length` of 273.47s.
...
| BLIP + YOLO + AST + ASR in Gemini2.5Pro |          6.23 |        0.053 |       0.023 |      0.019 |           0 |

**Footnote:**
`total_process_sec` without LLM cooldown of 797.85s is **3.25× longer** than `video_length` of 245.75s.
...
| BLIP + YOLO + AST + ASR in Gemini2.5Pro |         5.897 |        0.278 |         0.2 |      0.243 |           0 |

**Footnote:**
`total_process_sec` without LLM cooldown of 118.47s is **4.08× longer** than `video_length` of 29.03s.
