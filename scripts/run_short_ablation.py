...
DEFAULT_SOURCE_CHECKPOINT = PROJECT_ROOT / "_processed" / "._SHORT.mp4" / "checkpoint.json"
DEFAULT_VIDEO_PATH = "._SHORT.mp4"
DEFAULT_OUTPUT_ROOT = PROJECT_ROOT / "_processed_ablations" / "._SHORT.mp4"
...
def run_ablation(
    ...
    for variant in VARIANTS:
        ...
        try:
            emit(f"[llm] {variant}")
            run_llm_stage(checkpoint_path, video_path)
