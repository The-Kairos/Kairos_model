...
def eval_moment_retrieval(submission, ground_truth, verbose=True):
    ...
    for l_range, name in zip(length_ranges, range_names):
        ...
        iou_thd2average_precision = compute_mr_ap(_submission, _ground_truth, num_workers=1, chunksize=50)
...
def compute_hl_ap(qid2preds, qid2gt_scores_binary, num_workers=1, chunksize=50):
